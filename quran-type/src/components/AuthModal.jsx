...
export default function AuthModal({ onClose }) {
  ...
  const { login, signup, isLoading, error, clearError, googleLoginUrl } = useAuthStore()
  ...
  const inputBg = theme === 'dark' ? '#111' : '#f5f5f3'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          href={googleLoginUrl()}
          className="flex items-center justify-center gap-3 w-full py-2.5 rounded-xl border text-sm font-medium mb-4 hover:opacity-80 transition-opacity"
